...
class Index implements ControllerProviderInterface
{
    ...
    public function index(Request $request, Application $app)
    {
        ...
        if ($email3 != false) {
            echo 'xml pucp:'.$user->persondeoctrcorreopucpc.'<br>';
        }
        return '';
    }
